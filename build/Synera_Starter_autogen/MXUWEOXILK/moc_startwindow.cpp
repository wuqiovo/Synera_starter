...
void StartWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->loadGameRequested((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->onNewGameClicked(); break;
        case 3: _t->onLoadGameClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (StartWindow::*)()>(_a, &StartWindow::startNewGame, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (StartWindow::*)(const QString & )>(_a, &StartWindow::loadGameRequested, 1))
            return;
    }
}
...
// SIGNAL 1
void StartWindow::loadGameRequested(const QString & _t1)
{
