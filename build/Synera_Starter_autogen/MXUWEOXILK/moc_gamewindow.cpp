...
template <> constexpr inline auto GameWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10GameWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "",
        "onEndDeploymentClicked",
        "onEndBattleDebugClicked",
        "onResetAllDebugClicked",
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onEndDeploymentClicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onEndBattleDebugClicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onResetAllDebugClicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onSaveAndExitClicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'refreshInfoPanels'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onBattleStateChanged'
...
void GameWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onEndDeploymentClicked(); break;
        case 2: _t->onEndBattleDebugClicked(); break;
        case 3: _t->onResetAllDebugClicked(); break;
